...
const Map = (props) => {
  ...
  const zoomToLocation = function (id, type) {
    if (type == 'bojen') {
      ...
      setViewport({
        longitude: parseFloat(aktuelles[aktuellesIds.indexOf(id)].longitude),
        latitude: parseFloat(aktuelles[aktuellesIds.indexOf(id)].latitude),
        zoom: 13,
        transitionDuration: 1000,
        transitionInterpolator: new FlyToInterpolator(),
      })
      ...
      setViewport({
        longitude: parseFloat(geschichte[geschichteIds.indexOf(id)].longitude),
        latitude: parseFloat(geschichte[geschichteIds.indexOf(id)].latitude),
        zoom: 13,
        transitionDuration: 1000,
        transitionInterpolator: new FlyToInterpolator(),
      })
      ...
      setViewport({
        longitude: parseFloat(visionen[visionenIds.indexOf(id)].longitude),
        latitude: parseFloat(visionen[visionenIds.indexOf(id)].latitude),
        zoom: 13,
        transitionDuration: 1000,
        transitionInterpolator: new FlyToInterpolator(),
      })
  ...
  const toggleSmallPopUp = function (id, type) {
    ...
    let smallPopUpObj = {}
    if (type == 'bojen') {
      smallPopUpObj.latitude = parseFloat(bojen[bojenIds.indexOf(id)].latitude)
      ...
      smallPopUpObj.longitude = aktuelles[aktuellesIds.indexOf(id)].longitude
      ...
      smallPopUpObj.latitude = geschichte[geschichteIds.indexOf(id)].latitude
      smallPopUpObj.longitude = geschichte[geschichteIds.indexOf(id)].longitude
      smallPopUpObj.name = geschichte[geschichteIds.indexOf(id)].name
      smallPopUpObj.excerpt = geschichte[geschichteIds.indexOf(id)].excerpt
      smallPopUpObj.url = geschichte[geschichteIds.indexOf(id)].url
    } else if (type == 'visionen') {
      smallPopUpObj.latitude = visionen[visionenIds.indexOf(id)].latitude
      smallPopUpObj.longitude = visionen[visionenIds.indexOf(id)].longitude
    ...
    <>
      ...
      <div className="map-control-overlay">
        <div className="map-control-container">
          <div
            className={`myButton_Bojen${bojenVisible ? `` : `_toggled`}`}
          ...
          <div
            className={`myButton_Visionen${visionenVisible ? `` : `_toggled`}`}
